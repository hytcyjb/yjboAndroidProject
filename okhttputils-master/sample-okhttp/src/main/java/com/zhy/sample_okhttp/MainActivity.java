...
public class MainActivity extends AppCompatActivity
{
    ...
    public void getHtml(View view)
    {
        ...
        url="http://bag.89mc.com/ba/api/login/phone_login?platform=android&phone=18911966148&passwd=e10adc3949ba59abbe56e057f20f883e&imei=869231026460098";
        OkHttpUtils
                .get()
                .url(url)
                .id(100)
    ...
    public void postFile(View view)
    {
        ...
        if (!file.exists())
        {
            Toast.makeText(MainActivity.this, "文件不存在，请修改文件路径"+Environment.getExternalStorageDirectory(), Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    {
        Log.e("--yjbo--",new Gson().toJson(new User("zhy", "123")));
...
//                });
    ...
    {
        String url = "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1497954869590&di=af0fa8c9784aa22dc2a402f3765fbcf6&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimgad%2Fpic%2Fitem%2Fb58f8c5494eef01f3e82aae8eafe9925bc317d0c.jpg";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
